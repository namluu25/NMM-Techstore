                    ...
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu" id="dropdown">
                                <li class="nav-item"><a class="nav-link" id="type" href="<?php echo e(asset('shop/category/1')); ?>">Theo loại</a></li>
                                <li class="nav-item"><a class="nav-link" id="brand" href="<?php echo e(asset('shop/brand/1')); ?>">Theo hãng</a></li>
                            </ul>
                        </li>
