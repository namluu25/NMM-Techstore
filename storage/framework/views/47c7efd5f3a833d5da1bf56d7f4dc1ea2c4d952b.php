        ...
        <div class="banner_inner d-flex align-items-center">
            <div class="container">
                <div class="banner_content text-center">
                    <h2><?php echo e($loai_sp->name); ?></h2>
                    <div class="page_link">
                        <a href="index.html">Home</a>
                        <a href="category.html">Category</a>
                        <a href="category.html"><?php echo e($loai_sp->name); ?></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-9">
                    <div class="product_top_bar">
                        <div class="left_dorp">
                            <font size="4">Hiển thị <?php echo e(count($sp_theoloai)); ?> sản phẩm</font>
                        </div>
                        <div class="right_page ml-auto">
                            <div class="row"><?php echo e($sp_theoloai->links()); ?></div>
                        </div>
                    </div>
                    <div class="latest_product_inner row">
                        <?php $__currentLoopData = $sp_theoloai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('homepage.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/nmm/resources/views/homepage/category.blade.php ENDPATH**/ ?>